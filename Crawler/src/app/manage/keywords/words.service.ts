...
export class WordsService implements OnInit{
    ...
    url: string = "http://3.15.44.120:5000/keywords"
    url2: string = "http://3.15.44.120:5000/addKeyword";
    url3: string = "http://3.15.44.120:5000/deleteKeyword/";
    ...
    deleteKeyWord(word): Observable<void> {
        const url = `http://3.15.44.120:5000/deleteKeyword/${word}`;
